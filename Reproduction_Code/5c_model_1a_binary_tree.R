...
# Extract grid values as plain scalars, not sub-lists.
...
# Pulling scalars explicitly so chosen values are plain numbers
chosen <- list(
...
# Building final_params as a plain named list with a scalar value
