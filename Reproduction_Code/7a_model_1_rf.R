...
# Predicting P(y = 1) from a ranger
...
# sorting with explicit columns.
sort_params <- c("max_depth", "min_samples_leaf", "max_features",
                 "min_samples_split")
...
# Extracting scalars explicitly from the top candidate row.
chosen <- list(
